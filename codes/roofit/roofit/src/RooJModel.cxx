...
//-----------------------------------------------------------------------------
// Implementation file for class : RooJModel
//
...
RooJModel::RooJModel( const char *name, 
                      const char *title,
...
RooJModel::RooJModel( const RooJModel& other,
                      const char* name ) : 
...
Double_t RooJModel::evaluate() const 
{  
  Double_t val = 0.0;
...
Int_t RooJModel::getAnalyticalIntegral( RooArgSet& allVars,
                                                RooArgSet& analVars,
...
Double_t RooJModel::analyticalIntegral( Int_t code,
                                        const char* rangeName) const
{
